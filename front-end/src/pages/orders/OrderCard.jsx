...
export default function OrderCard({order: {id,orderTimeMs,totalCostCents,products}}) {
    return (
        <div className="border border-neutral-300 rounded-md">
            <div className="py-5 px-6 flex items-center gap-8 justify-between border-b border-neutral-300">
                <div className="flex items-center gap-11">
                    <div className="flex flex-col">
                        ...
                        <span className="leading-none">{new Date(orderTimeMs).toLocaleDateString('en-US', { month: 'long', day: 'numeric' })}</span>
                    </div>
                    <div className="flex flex-col">
            ...
            <div className="px-6 py-2 flex flex-col gap-4">
                {products.map((product)=>{
                    return <OrderItem id={id} product={product}  key={product.productId}/>
                })}
            </div>
        </div>
    );
