    ...
    return (
        <div className="fixed z-10 top-0 left-0 right-0 py-2.5 px-2 flex xs:gap-5 md:gap-20 lg:gap-40 items-center justify-between bg-green-900">
            ...
            <div className="flex grow min-w-0 relative">
                <svg className="fill-neutral-700 absolute top-[50%] translate-y-[-50%] left-2" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    viewBox="0 0 24 24">
            ...
            <div className="text-white font-semibold flex xs:gap-2">
                ...
                <Link to="/checkout" className="flex items-center px-1 xs:px-3">
                    <span className="relative">
                        ...
                        <span className="absolute top-[50%] left-[50%] translate-x-[-40%] translate-y-[-70%] text-green-700 text-[12px]">{cart.count}</span>
                    </span>
